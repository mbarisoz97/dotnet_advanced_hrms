...
namespace Ehrms.Authentication.API.Migrations
{
    ...
    [Migration("20240822100152_Add_User_MustChangePassword")]
    partial class Add_User_MustChangePassword
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ehrms.Authentication.API.Database.Models.UserRole", b =>
                {
            ...
            modelBuilder.Entity("Ehrms.Authentication.API.Database.Models.UserRole", b =>
                {
                    b.HasOne("Ehrms.Authentication.API.Database.Models.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ehrms.Authentication.API.Database.Models.User", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
